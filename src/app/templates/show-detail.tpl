...
<div class="tv-poster">
	...
	<div class="tv-meta-data">
		...
		<div class="tv-runtime"><%= duration %> Min</div>
		<div class="tv-dot"></div>
		...
		<div class="rating-container-tv">
			<% p_rating = Math.round(rating) / 2; // Roundoff number to nearest 0.5 %>
...
<div class="episode-base">
	<div class="episode-info">
		...
		<div data-toggle="tooltip" data-placement="left" title="<%=i18n.__("Update link") %>" class="fa fa-magnet show-magnet-link"></div>
		<div data-toggle="tooltip" data-placement="left" title="<%=i18n.__("Update link") %>" class="fa fa-circle show-loading-link"></div>
						...
						<ul>
							...
							%>
								<li class="tab-episode" data-id="<%=episodeData.e_id %>" data-season="<%=episodeData.season %>" data-episode="<%=episodeData.episode %>">
									...
									<div id="watched-<%=episodeData.season%>-<%=episodeData.episode%>" data-toggle="tooltip" data-placement="left" title="<%=i18n.__("Loading") %>" style="margin-top: 11px; margin-right: 5px;" class="fa fa-circle health-icon None"></div>
